...
This is a mobile application that displays weather data for various cities provided by the API. The app is designed with a focus on user experience, performance and architecture including features like offline mode, error handling and localization.
...
npm run test
 ...
 The initial development of this app was completed within a tight deadline of 5 days.